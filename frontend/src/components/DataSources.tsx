    ...
    <Card className={`h-full ${className}`}>
      <CardContent className="p-4 h-full flex flex-col">
        ...
        {importedFiles.length === 0 ? (
          <>
            ...
            {isImporting && (
              <div className="text-center py-8">
                ...
                <p className="mt-2 text-sm text-gray-600">Importing files...</p>
              </div>
            )}
            
            {/* Import Area - Hide when loading */}
            {!isImporting && (
          <div 
          ...
          >
            {/* Loading Spinner for additional imports */}
            {isImporting && (
              <div className="text-center py-4 mb-4">
                <div className="inline-block animate-spin rounded-full h-6 w-6 border-b-2 border-blue-600"></div>
                <p className="mt-2 text-sm text-gray-600">Importing additional files...</p>
              </div>
            )}
                  ...
                  <div key={file.name} className="border rounded-lg p-3 bg-white">
                    <div className="flex items-start justify-between">
                      <div className="flex-1 min-w-0 mr-3">
                        ...
                        {showHeaderConfig && file.headerConfig && !file.headerConfig.autoDetected && (
