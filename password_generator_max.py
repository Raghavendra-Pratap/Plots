...
class PasswordGeneratorApp:
    def __init__(self, root):
        ...
        # "Need Help" hyperlink at bottom right
        self.help_label = tk.Label(
            ...
            bg=self.root.cget("bg")  # Use the root's background color
        )
        self.help_label.place(relx=1.0, rely=1.0, anchor="se", x=-10, y=-10)
        self.help_label.bind("<Button-1>", lambda e: webbrowser.open("https://raghavendrapratap.com"))
